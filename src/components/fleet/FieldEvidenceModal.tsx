  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-neutral-900 border border-neutral-700/80 rounded-2xl shadow-2xl overflow-hidden flex flex-col text-neutral-100 max-h-[92vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-3.5 py-3 sm:px-5 sm:py-4 bg-gradient-to-r from-neutral-850 to-neutral-800 border-b border-neutral-700/80 shrink-0">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 pr-2">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                <span className="text-[9px] sm:text-[10px] px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-300 font-mono font-medium border border-amber-500/30 shrink-0">
                  SECTION 10
                </span>
              </div>
              <p className="text-[11px] sm:text-xs text-neutral-400 truncate">
                Camera & GPS → AI Pipeline → Live Map
              </p>
            </div>
          </div>
          <button
        ...
        {/* Body Form */}
        <div className="p-3.5 sm:p-5 overflow-y-auto space-y-3.5 sm:space-y-4 overscroll-contain flex-1">
          {successResult ? (
            <div className="p-4 bg-emerald-950/60 border border-emerald-500/50 rounded-2xl text-center space-y-3">
              ...
              <div className="pt-2 flex justify-center gap-2">
                <button
                  ...
                  className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold transition min-h-[40px]"
                >
                  View on Live Map
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className={`text-xs font-bold font-mono px-2 py-0.5 rounded ${
                    ...
                    {severity} / 10 ({severity >= 8 ? 'CRITICAL' : 'HAZARD'})
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="p-3 bg-neutral-800/60 border border-neutral-700/60 rounded-xl space-y-2">
                <div className="flex items-center justify-between gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    disabled={isLocating}
                    className="px-2.5 py-1.5 bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 border border-blue-500/30 rounded-lg text-[11px] font-medium flex items-center gap-1.5 transition min-h-[32px]"
                  >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-mono text-neutral-200">
                  <div className="bg-neutral-900 px-2.5 py-1.5 rounded border border-neutral-800 truncate">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-neutral-800 border border-neutral-700 rounded-lg px-3 py-2 text-xs text-white mb-2 focus:outline-none focus:border-amber-500"
                >
              ...
              <button
                ...
                className="w-full min-h-[44px] py-3 px-4 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-neutral-950 font-bold text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-amber-600/25 flex items-center justify-center gap-2 transition"
              >
                {isSubmitting ? (
                  <>
